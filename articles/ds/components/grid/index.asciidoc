...
Components such as <<../input-fields#,input fields>> and <<../buttons#,Buttons>> are also supported.
...
[source, java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridContent.java[render,tags=snippet,indent=0,group=Java]
----
--
...
[source, java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridComponentRenderer.java[tags=snippet,indent=0,group=Java]
----
--
...
[source, java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridTemplateRenderer.java[tags=snippet,indent=0,group=Java]
----
--
...
Grid supports single and multiselect.
...
[source, java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridMultiSelectMode.java[render,tags=snippet,indent=0,group=Java]
----
--
...
Each column has its own customisable header and footer.
...
[source, java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridColumnHeaderFooter.java[render,tags=snippet,indent=0,group=Java]
----
--
...
You can provide the user with a menu for toggling column visibilities, for example, using MenuBar.
...
[source, java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridColumnVisibility.java[render,tags=snippet,indent=0,group=Java]
----
--
...
[source, java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridBuiltInFiltering.java[render,tags=snippet,indent=0,group=Java]
----
--
...
[source, java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridFilter.java[render,tags=snippet,indent=0,group=Java]
----
--
...
[source, java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridItemDetails.java[render,tags=snippet,indent=0,group=Java]
----
--
...
[source, java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridItemDetailsToggle.java[render,tags=snippet,indent=0,group=Java]
----
--
...
[source, java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridContextMenu.java[render,tags=snippet,indent=0,group=Java]
----
--
...
There are 4 different drop modes:
...
|<<#on-grid,On Grid>>
|Drops can occur on the Grid as whole, not on top of or between individual rows. Use this option when the order is unimportant.
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-drag-and-drop-filters.ts[render,tags=snippet,indent=0,group=TypeScript]
----

[source, java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridDragAndDropFilters.java[render,tags=snippet,indent=0,group=Java]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-inline-editing-buffered.ts[render,tags=snippet,indent=0,group=TypeScript]
----

[source, java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridInlineEditingBuffered.java[render,tags=snippet,indent=0,group=Java]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-inline-editing-non-buffered.ts[render,tags=snippet,indent=0,group=TypeScript]
----

[source, java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridInlineEditingNonBuffered.java[render,tags=snippet,indent=0,group=Java]
----
--

Alternatively, use <<../grid-pro#,Grid Pro>> for more streamlined inline-editing, or CRUD for editing in a separate side panel or dialog.
